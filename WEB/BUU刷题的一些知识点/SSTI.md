...
1.  https://www.k0rz3n.com/2018/11/12/一篇文章带你理解漏洞之SSTI漏洞/#参考链接)
...
[![此处输入图片的描述](SSTI/SSTI浅析-检测原理.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/SSTI浅析-检测原理.png)
...
[![此处输入图片的描述](SSTI/Twig_self.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/Twig_self.png)此处输入图片的描述

Twig 给我们提供了一个 `_self`, 虽然 `_self` 本身没有什么有用的方法，但是却有一个 env

**如下图所示：**

[![此处输入图片的描述](SSTI/Twig_env1.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/Twig_env.png)此处输入图片的描述
...
[![此处输入图片的描述](SSTI/Twig_setCache.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/Twig_setCache.png)此处输入图片的描述
...
[![此处输入图片的描述](SSTI/django-seetings.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/django-seetings.png)此处输入图片的描述
...
[![此处输入图片的描述](SSTI/flask-config.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/flask-config.png)此处输入图片的描述
...
[![此处输入图片的描述](SSTI/Python exec.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/Python exec.png)此处输入图片的描述

我们简单的模拟一下看一下效果

**如图所示:**

[![此处输入图片的描述](SSTI/d.__dict__.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/d.__dict__.png)此处输入图片的描述
[![此处输入图片的描述](SSTI/d.__dict__2.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/d.__dict__2.png)此处输入图片的描述
...
[![此处输入图片的描述](SSTI/cookie_secret.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/cookie_secret.png)此处输入图片的描述
...
[![此处输入图片的描述](SSTI/handler.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/handler.png)此处输入图片的描述
...
![此处输入图片的描述](SSTI/handler_settings-163156262625213.png)]此处输入图片的描述
...
[![此处输入图片的描述](SSTI/java.lang.png)](https://picture-1253331270.cos.ap-beijing.myqcloud.com/java.lang.png)此处输入图片的描述
...
[web安全 漏洞分析](https://www.k0rz3n.com/tags/web安全-漏洞分析/)